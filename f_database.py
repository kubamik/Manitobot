factions_roles = {
    "Bandyci": ["Herszt", "Mściciel", "Złodziej", "Zły_Rew", "Szantażysta",
                "Szuler"],
    "Indianie": ["Wódz", "Szaman", "Szamanka", "Samotny_Kojot", "Płonący_Szał",
                 "Lornecie_Oko", "Cicha_Stopa"],
    "Ufoki": ["Wielki_Ufol", "Zielona_Macka", "Detektor", "Pożeracz_Umysłów",
              "Purpurowa_Przyssawka"],
    "Inkwizycja": ["Kardynał", "Biskup", "Misjonarz", "Spowiednik", "Wikary",
                   "Anioł", "Ministrant"],
...
f_actions = {
    ...
    "Indianie": [("kill", None), ("kill", True), ("hold", True),
                 ["Samotny_Kojot"], ["Płonący_Szał"], ["Szamanka"],
                 ["Wojownik"], ["Cicha_Stopa"]],
    "Ufoki": [["Detektor"], ["Pożeracz_Umysłów"], ("search", False),
              ["Zielona_Macka"], ["Purpurowa_Przyssawka"], ("signal", True),
              ("hold", True)],
    "Inkwizycja": [["Wikary"], ["Misjonarz"], ["Spowiednik"], ("search", False),
                   ("check", True), ("hold", True)]
}
