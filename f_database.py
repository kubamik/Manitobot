...
f_actions = {
    ...
    "Indianie": [("kill", None), ("hold", True), ("kill", True), ["Samotny_Kojot"], ["Płonący_Szał"], ["Szamanka"],
                 ["Wojownik"], ["Cicha_Stopa"]],
    "Ufoki": [["Detektor"], ["Pożeracz_Umysłów"], ("search", False), ["Zielona_Macka"], ["Purpurowa_Przyssawka"],
              ("signal", True), ("hold", True)],
