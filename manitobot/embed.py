...
embed = discord.Embed(title="Głosowanie: Pojedynek", colour=discord.Colour(0x00aaff),
                      description="Masz 1 głos na osobę, która ma **wygrać** pojedynek.\n\n**1, Kuba**\n\n**2, Anioła**\n\n**3, fk**\n\n**4, Wstrzymuję_Się**")
...
embed.add_field(name="Akcja",
                value="`&komenda` - Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.",
                inline=False)
embed.add_field(name="Akcja",
                value="`&komenda` - Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")
person = bot.owner_id  #
