...
role_activities = {
    ...
    "Misjonarz": (1, -1, {"start": "unwork", "heretic": -1, "research": 1, "refuse": -1, "die": "angelize",
...
SPEC_ROLES = {
    ...
    "decline_duels_dark": "Lucky_Luke",
    "duel_change": ["Sędzia", "Pijany_Sędzia"],
    "hang_change": ["Burmistrz"]
}
...
def get_activity(name, obj):
    activities = {
        ...
        "duel_day_refuse": [obj.send_refusal, obj.del_state_special_msg],
        "hang_day_refuse": [obj.send_refusal, obj.del_state_special_msg],
        ...
        "play": [obj.if_active, obj.if_not_self, obj.if_protected, obj.unrefuse, obj.if_better, obj.kill,
                 obj.special_search, obj.alone],
        "kill": [obj.if_active, obj.if_worked, obj.if_protected, obj.kill_send, obj.kill, obj.search, obj.set_use,
                 obj.deactivate, obj.reactivate_luke],
        ...
        "search": [obj.if_active, obj.if_not_worked, obj.if_protected, obj.search_send, obj.search, obj.set_use,
                   obj.deactivate, obj.reactivate_luke, obj.make_it_work],
        "unwork": [obj.unwork],
        ...
        "mirror": [obj.if_active, obj.if_not_worked, obj.if_not_self, obj.check_role, obj.make_it_work, obj.mirror_send,
                   obj.deactivate_cond],
        ...
        "follow": [obj.if_active, obj.if_worked, obj.if_not_self, obj.follow, obj.deactivate, obj.follow_send,
                   obj.reactivate_luke]
    }
